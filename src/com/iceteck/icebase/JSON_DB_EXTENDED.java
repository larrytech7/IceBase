 ...
 * @author Larry Akah
 * @version 1.0.0
 * This class is developed as a means to simplify and optimize the initial json_db implementation.
 * It fully utilizes java's JSON API available to implement the CRUD functionality of the json_db library.
...
public class JSON_DB_EXTENDED {
	...
	/**
	 * Inserts a set('rows') into the data store
	...
	public JSON_DB_EXTENDED put(ArrayList<Object> items) throws JSONException{
		...
		String item_id = DB_Utility.generateRandomId();
   ...
   public int insert(ArrayList<Object> item){
	...
	/**
	 * This is intended for bulk updates.
	 ...
	 * @throws JSONException 
	 */
	public JSON_DB_EXTENDED delete(String itemID) throws JSONException{
	...
	/**
	 * uploads database files to cloud
	 * @param server
	 * @param user
	 * @param pass
	 */
